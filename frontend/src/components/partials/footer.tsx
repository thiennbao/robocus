const Footer = () => {
  const navigation = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Nội dung - Bảng B1", href: "" },
        { name: "Nội dung - Bảng B2", href: "" },
  ...
  return (
    <div className="p-10">
      ...
      <div className="w-full flex justify-between mt-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-4">
            <input
              type="email"
              className="w-[20rem] p-3 px-5 rounded-full border font-light"
      ...
      <p className="text-xs font-extralight mt-8">Copyright &copy; {new Date().getFullYear()} Robocus</p>
    </div>
  );
};
